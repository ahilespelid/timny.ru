            ...
            <div class="row mx-0">
                <div class="col-sm-12 col-md-6">
                    <div
                        ...
                        <a href="/">
                            <img :src="url + '/assets/images/sign-up-logo.png'" alt="" style="max-width: 100%; height: auto;"/></a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content border-0">
                            <div class="modal-header text-white bg-primary">
                                <h5 class="modal-title text-white" id="exampleModalLabel">Правила и условия</h5>
...
export default {
    props: ["url", "user_id", "access_token", "login_type"],
    mixins: [loginMixin],
    data() {
        return {
            timerCount: 60,
    ...
    methods: {
        ...
        doMenteeLogin() {
            ...
            if (this.mentee_condition == "") {
                toast.success("Пожалуйста, выберите Правила и условия");
                return false;
            }
        ...
        sendOTP() {
            ...
            verify() {
              ...
              window.confirmationResult
                ...
                .catch(function (error) {
                  toast.error("Проверочный код недействителен");
                });
            },
            doLogin() {
      var number;
    ...
    {
        if (this.is_mentor == true) {
            this.$toasted.error('Пожалуйста, Проверьте Recapcha')
            this.sendOTP();
        }
        if (this.is_mentor == false) {
            this.$toasted.error('Пожалуйста, Проверьте Recapcha')
    ...
    mounted() {
        ...
        if (this.user_id) {
            ...
            if (role == "Mentor") {
                ...
                toast.success("Успешно Войдите в систему");
