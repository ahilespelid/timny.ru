              ...
              >
                ...
                >
                  <a
                    ...
                    >
                    <div class="sticky-bar-img rounded-circle  me-2">
                    <img
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item text-dark" :href="url+'/dashboard'">Панель</a>
                    <a class="dropdown-item text-dark" :href="url+'/mentor-profile'">Профиль</a>
                    <a class="dropdown-item text-dark" :href="url+'/generate-schedule'">Расписание</a>
                    <a class="dropdown-item text-dark" :href="url+'/mentor/appointment-log'">Журнал консультация</a>
                    <a class="dropdown-item text-dark" :href="url+'/wallet'">Кошелек</a>
                  ...
                  <div class="table-responsive mt-md-5 mt-4">
                    <table class="table table-borderless">
                      ...
                      <tbody class="text-dark">
                        ...
                        <tr v-if="todayAppointment.length == 0">
...
export default {
  ...
  created() {
    ...
    if (curHr < 12) {
      this.shiftMessage = "Доброе утро";
    } else if (curHr < 18) {
      this.shiftMessage = "Добрый день";
    } else {
      this.shiftMessage = "Добрый вечер";
    }
