                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-4">
                                        <toggle-button
                                            ...
                                            @change="
                                                onSVisibilityChangeEventHandler
                                            "
                                            :color="{
                                                checked: '#73bd49',
                                                unchecked: '#6c757d',
