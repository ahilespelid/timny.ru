          ...
          <div class="appointment-pills">
            <div class="row">
              <div class="col-xxl-3 col-lg-4">
                ...
                >
                  <h6 class="text-primary py-3">Выберите Тип встречи</h6>
                  <button
                  ...
                  >
                    <div class="d-flex align-items-center">
                      ...
                      <span
                        ...
                        "
                      >
                        <p class="mb-0 text-capitalize">Чат-консультация</p>
                  ...
                  >
                    <div class="d-flex align-items-center">
                      ...
                      <span
                        ...
                        "
                      >
                        <p class="mb-0 text-capitalize">Живая консультация</p>
                        <span class="text-muted"
                          >Стоимость
                          {{
              ...
              <div class="col-xxl-9 col-lg-8">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <h6 class="text-primary">
                              ...
                              <span class="text-muted">(встреча в Чате)</span>
                            </h6>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          <div class="col-md-12">
                            <h6 class="text-primary">
                                Расписание Не Требуется
                              <span class="text-muted">(Живая встреча)</span>
                            </h6>
                          </div>
                        </div>
                      </div>
                ...
                <div class="d-flex mt-4 justify-content-end align-items-center">
                  ...
                  @click="sendLiveAppointmentNotification()"
                  class="btn btn-secondary text-white px-4">
                      Продолжить
                    <i class="fa-solid fa-angles-right ms-1"></i>
                  </button>
...
export default {
  ...
  methods: {
      changeAppointmentType(appointmentTypeString,appointmentType,fee){
          ...
          console.log(this.appointment_live,appointmentType);
    ...
    async sendLiveAppointmentNotification() {
      const params = {
        token: 123,
        user_id: this.mentor_id,
        body: "Нажмите здесь, чтобы принять запрос на встречу в режиме реального времени ",
        title: "Запрос на встречу в режиме реального времени для Вас.",
