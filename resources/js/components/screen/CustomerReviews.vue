                            ...
                            <div class="col-md-9">
                                <div class="col-md-12">
                                    <h6 class="text-primary">
                                       {{parseFloat(satisfy_percentage).toFixed(2)}}% клиенты чувствуют себя удовлетворенными после
                                        записи на прием
                                    </h6>
                                    <p class="mb-0">
                                        Запись на прием занимает всего 30 секунд
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            >
                                ...
                                <h1 class="text-secondary fw-bold">Отзывы</h1>
                                <p>
                                            ...
                                            <div class="ps-3">
                                                ...
                                                >
                                                    <div class="col-md-12">
                                                        ...
                                                        <span>{{new Date(rating.created_at).toLocaleString('ru-RU')}}</span>
