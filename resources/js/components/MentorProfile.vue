        ...
        <div class="container">
            <div class="row mb-5">
                ...
                <div class="col-md-4 col-6">
                    <div
                        class="info d-flex justify-content-center h-100 flex-column"
                    >
                ...
                <div class="col-lg-6 col-md-5 col-11 mt-md-0 mt-4 status">
                    ...
                    <label class="text-capitalize"
                        >{{show_status}}
                        <i class="fa-solid fa-circle fs-9" :class="show_status=='offline' ? 'text-danger' : 'text-success'"></i
                    ></label>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <div
                                    class="border-top-nav position-relative mb-3"
                                >
                                    <i
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="text-dark mentor-head">
                                    {{
                                        $t(
                                            "mentor.profile.sections.step2.sub_heading"
                                        )
                                    }}
                                </div>
                            </button>
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="text-dark mentor-head">
                                    {{
                                        $t(
                                            "mentor.profile.account_information.title"
                                        )
                                    }}
                                </div>
                            </button>
                        ...
                        >
                            <div class="row">
                                <div class="col-md-3 border-end-c">
                                    <!-- <div class="info">
                                        <span
                                            class="text-primary fw-bold mt-5 mt-md-0"
                                        >
                                            {{
                                                $t(
                                                    "mentor.profile.general.welcome"
                                                )
                                            }}
                                        </span>
                                        ...
                                        >
                                            ...
                                            <div class="upload-btn-wrapper">
                                                ...
                                                >
                                                    ...
                                                    {{
                                                        $t(
                                                            "mentor.profile.general.upload_file"
                                                        )
                                                    }}
                                                </button>
                                                <input
                                    ...
                                    >
                                        <div class="row">
                                            ...
                                            >
                                                ...
                                                >
                                                    {{
                                                        $t(
                                                            "mentor.profile.general.place_holder.first_name"
                                                        )
                                                    }}
                                                </label>
                                                <input
                                            ...
                                            >
                                                <label
                                                    for=""
                                                    class="text-primary mb-2 mt-md-0 mt-4"
                                                >
                                                    {{
                                                        $t(
                                                            "mentor.profile.general.place_holder.last_name"
                                                        )
                                                    }}
                                                </label>
                                                <input
                                            ...
                                            >
                                                ...
                                                >
                                                    {{
                                                        $t(
                                                            "mentor.profile.general.place_holder.cnic"
                                                        )
                                                    }}
                                                </label>
                                                <input
                                            ...
                                            >
                                                ...
                                                >
                                                    {{
                                                        $t(
                                                            "mentor.profile.general.place_holder.country"
                                                        )
                                                    }}
                                                </label>
                                                <div class="custom-select">
                                            ...
                                            >
                                                ...
                                                >
                                                    {{
                                                        $t(
                                                            "mentor.profile.general.place_holder.city"
                                                        )
                                                    }}
                                                </label>
                                                <div class="custom-select">
                                            ...
                                            >
                                                ...
                                                >
                                                    {{
                                                        $t(
                                                            "mentor.profile.general.place_holder.address"
                                                        )
                                                    }}
                                                </label>
                                            ...
                                            >
                                                ...
                                                >
                                                    {{
                                                        $t(
                                                            "mentor.profile.general.place_holder.occupation"
                                                        )
                                                    }}
                                                </label>
                                                <div class="custom-select">
                                                ...
                                                <div class="custom-select">
                                                    ...
                                                    >
                                                        ...
                                                        <option
                                                            value="christian"
                                                        >
                                                            Христианин/Православный/Катлоик
                                                        </option>
                                                        <!--
                                                        <option value="hindu">
                                                            Hindu
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {{
                                                    $t(
                                                        "mentor.profile.general.btn_continue"
                                                    )
                                                }}
                                                <i
                                                    class="fa-solid fa-angles-right ms-1"
                                                ></i>
                                            </button>
                                        </div>
                                    </form>
                                ...
                                <div class="col-md-9">
                                    ...
                                    >
                                        <div class="row">
                                            ...
                                            >
                                                <div
                                                    class="upload-btn-wrapper mt-5 w-100"
                                                >
                                                    <button
                                                    ...
                                                    >
                                                        {{
                                                            $t(
                                                                "mentor.profile.education.place_holder.image"
                                                            )
                                                        }}
                                                    </button>
                                                    <input
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {{
                                                            $t(
                                                                "mentor.profile.education.place_holder.btn_label"
                                                            )
                                                        }}
                                                    </button>
                                                </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 d-flex align-items-center">
                                    <h5 class="text-primary">
                                        Добавьте информацию о образовании и
                                        сертификаты здесь
                                    </h5>
                                </div>
                                <div
                                        ...
                                        >
                                            <div class="modal-content border-0">
                                                <div class="modal-body py-5">
                                                    ...
                                                    >
                                                        Информация о образовании и сертификации
                                                    </h3>
                                                    <form
                                                        @submit="
                                                            submitEducationForm
                                ...
                                <table class="table table-striped align-middle">
                                    <tr class="text-primary light-bg">
                                        <th class="py-3">
                                            {{
                                                $t(
                                                    "mentor.profile.education.table.degree"
                                                )
                                            }}
                                        </th>
                                        <th class="py-3">
                                            {{
                                                $t(
                                                    "mentor.profile.education.table.subject"
                                                )
                                            }}
                                        </th>
                                        <th class="py-3">
                                            {{
                                                $t(
                                                    "mentor.profile.education.table.institution"
                                                )
                                            }}
                                        </th>
                                        <th class="py-3">
                                            {{
                                                $t(
                                                    "mentor.profile.education.table.Year"
                                                )
                                            }}
                                        </th>
                                        <th class="py-3">Изображение</th>
                                        <th class="py-3">Действие</th>
                                    </tr>
                                    <tr
                                        v-for="(
                                            education, index
 ...
 <tr v-if="allEducations.length == 0">
                        <td colspan="6" class="text-center">
                            ...
                            <!-- <div class="mt-5 mb-2">
                                ...
                                >
                                    <div
                                        class="col-lg-2 col-md-2 d-flex align-items-center"
                                    >
                        ...
                        >
                                ...
                                <div class="col-md-9">
                                    ...
                                    >
                                        <h4 class="text-primary fw-bold">
                                            {{
                                                $t(
                                                    "mentor.profile.experience.title"
                                                )
                                            }}
                                        </h4>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {{
                                                            $t(
                                                                "mentor.profile.experience.place_holder.image"
                                                            )
                                                        }}
                                                    </button>
                                                    <input
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {{
                                                            $t(
                                                                "mentor.profile.experience.place_holder.btn_label"
                                                            )
                                                        }}
                                                    </button>
                                                </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 d-flex align-items-center">
                                    <h5 class="text-primary">
                                        Добавьте информацию о опыте и сертификаты здесь
                                    </h5>
                                </div>
                                <div
                                    class="col-md-6 d-flex align-items-center justify-content-end"
                                ...
                                <table class="table table-striped align-middle">
                                    <tr class="text-primary light-bg">
                                        <th class="py-3">
                                            {{
                                                $t(
                                                    "mentor.profile.experience.table.company"
                                                )
                                            }}
                                        </th>
                                        <th class="py-3">
                                            {{
                                                $t(
                                                    "mentor.profile.experience.table.period_from"
                                                )
                                            }}
                                        </th>
                                        <th class="py-3">
                                            {{
                                                $t(
                                                    "mentor.profile.experience.table.period_to"
                                                )
                                            }}
                                        </th>
                                    ...
                                    >
                                        ...
                                        <td>
                                            {{ (new Date(experience.from)).toLocaleString('ru-RU',{
                                                year: 'numeric',
                                                month: 'short',
                                                day: 'numeric',
                                            }) }}
                                        ...
                                        <td>
                                            {{ (new Date(experience.to)).toLocaleString('ru-RU',{
                                                year: 'numeric',
                                                month: 'short',
                                                day: 'numeric',
                                            }) }}
                        ...
                        <td colspan="5" class="text-center">
                            ...
                            <!-- <div class="mt-5 mb-4">
                                ...
                                >
                                    ...
                                    <div
                                        class="col-lg-2 col-md-4 d-flex align-items-center"
                                    >
                                        <label for="" class="text-primary">
                                            {{
                                                $t(
                      ...
                      ></a>
                        ...
                        >
                                        ...
                                        <div class="row" v-else>
                                            ...
                                            >
                                                <label
                                                    ...
                                                    >{{
                                                        $t(
                                                            "mentor.profile.skill.select_categories"
                                                        )
                                                    }}</label
                                                >
                                            ...
                                            <div class="col-md-6 mt-2">
                                                <div
                                                    class="upload-btn-wrapper mt-4 w-100"
                                                >
                                                    <button
                                                        class="mt-2 h-100 btn btn-upload d-flex justify-content-center border-0 bg-primary text-white w-100"
                                                        v-on:click="addSkill"
                                                    ...
                                                    >
                                                        {{
                                                            $t(
                                                                "mentor.profile.skill.btn_label"
                                                            )
                                                        }}
                                                    </button>
                                                </div>
                            ...
                            <div
                                class="bg-light border-top border-bottom mt-5 p-4"
                            >
                                <div class="row mb-2">
                                    <div class="col-md-12">
                                        <label
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 d-flex align-items-center">
                                    <h5 class="text-primary">
                                        Добавьте ваши профессиональные умения и навыки здесь
                                    </h5>
                                </div>
                                <div
                                    class="col-md-6 d-flex align-items-center justify-content-end"
                                ...
                                <table class="table table-striped align-middle">
                                    <tr class="text-primary light-bg">
                                        <th class="py-3">
                                            {{
                                                        $t(
                                                            "mentor.profile.skill.categories"
                                                        )
                                                    }}
                                        </th>
...
export default {
    ...
    methods: {
            ...
            const res = await axios
                ...
                .then((res) => {
                    if (res.data.Status) {
                        ...
                        console.log("this.show_status",this.show_status);
                    }
                    if (!res.data.Status) {
            ...
            if (res.data && res.data.Status) {
                if (res.data.data.card) {
                    ...
                    this.bank.account_number =
                        res.data.data.card.account_number;
                    this.bank.id = res.data.data.card.id;
                }
            }
        },
        async fetchSubcategories(event, index) {
            ...
            const res = await axios.get("/api/mentorChildCategoriesList", {
                params,
            });
            if (res.data && res.data.Status) {
        ...
        processFile(event) {
            ...
            this.profile.image_view = URL.createObjectURL(
                event.target.files[0]
            );
        },
        processEducationFile(event) {
            this.education.image = event.target.files[0];
            this.education.image_view = URL.createObjectURL(
                event.target.files[0]
            );
        },
        ...
        async deleteMentorExperiences(id, index) {
            ...
            const res = await axios
                ...
                .then((res) => {
                    if (res.data.Status) {
                        toast.success(res.data.msg);
                        this.allExperiences.splice(
                            this.allExperiences.indexOf(id),
                            index
                        );
                    }
                });
        ...
        processExperienceFile(event) {
            ...
            this.experience.image_view = URL.createObjectURL(
                event.target.files[0]
            );
        },
