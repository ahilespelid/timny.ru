            ...
            <div class="row mx-0">
                <div class="col-sm-12 col-md-6">
                    <div
                        ...
                        <a href="/"><img :src="url + '/assets/images/sign-up-logo.png'" alt="" style="max-width: 100%; height: auto;"/></a>
                                ...
                                <div class="form-signup">
                                    ...
                                    <div class="form-check mb-2 mt-3 col-12 d-flex align-items-center">
                                        ...
                                        <label class="form-check-label ms-2" for="mentor_condition"><a
                                                ...
                                                href="javascript:void(0)">Согласны с нашими правилами и условиями</a></label>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                ...
                                <div class="form-signup">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <input type="text" name="mentor_first_name" id="mentor_first_name"
                                                placeholder="Ваше имя" class="form-control mt-4"  :class="errors && errors.first_name ? 'border-danger' : ''" />
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="mentor_last_name" id="mentor_last_name"
                                                placeholder="Ваша фамилия" class="form-control mt-4"  :class="errors && errors.last_name ? 'border-danger' : ''" />
                                    ...
                                    <input type="email" name="mentor_email" id="mentor_email"
                                        placeholder="Email" class="form-control mt-4"  :class="errors && errors.email ? 'border-danger' : ''" />
                                    ...
                                    <div class="position-relative">
                                        <input :type="type" name="mentor_password" id="mentor_password"
                                            placeholder="Пароль" class="form-control mt-4"  :class="errors && errors.password ? 'border-danger' : ''" />
                                    ...
                                    <div class="position-relative">
                                        <input :type="type" name="mentor_confirm_password" id="mentor_confirm_password"
                                            placeholder="Подтвердите пароль" class="form-control mt-4" :class="errors && errors.password ? 'border-danger' : ''" />
                                        <a v-if="c_icon == 'show'" href="javascript:void(0)">
                                            <i class="fa-solid fa-eye position-absolute" id="togglePassword"
                                                @click="showConfirmPassword"></i>
                                        </a>
                                ...
                                <p class="text-center mt-4 signin">
                                    Уже есть аккаунт?
                                    <a href="/login" class="text-decoration-none">Войти</a>
                                </p>
                                <hr />
                                <p class="text-center">
    ...
    methods: {
        ...
        registerMentor() {
            ...
            if (this.mentor_condition == "") {
                toast.error("Пожалуйста подтвердите согласие с нашими правилами и условиями");
                return false;
            }
            ...
            console.log(email, password, confirm_password, mentor_fbId);
            const params = {
                role: "Mentor",
                email: email,
                password: password,
        ...
        async fetchTermsAndConditions() {
            ...
            if (res.data.data.value ?? false) {
                ...
                // console.log('terms_and_conditions',this.terms_and_conditions);
            }
        }
    },
    created() {
        // console.log(this.fbemail);
        // console.log(document.getElementById('pills-profile-tab'));
