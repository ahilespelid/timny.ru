      ...
      <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-secondary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="{{route('admin.testinomials.store')}}" enctype="multipart/form-data"  method="post">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input height="100px" width="100px" type="file"  onchange="openFile(this)" class="form-control h-100" name="image" placeholder="Testimonial Image">
                          </div>
