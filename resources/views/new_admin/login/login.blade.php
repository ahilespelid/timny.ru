...
<head>
  ...
  <title>Consultant Admin | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <img src="{{asset('assets/images/sign-up-logo.png')}}" alt="">
    <br>
    <h4 class="my-4"><a href=""><b>Consultant</b> Admin</a></h4>
  </div>
  <!-- /.login-logo -->
  <div class="card mb-5">
    <div class="card-body login-card-body">
      ...
      @csrf
        ...
        <div class="input-group mb-3">
          ...
          name="password"
          value="admin@123" class="form-control" placeholder="Password">
          <div class="input-group-append">
            <div class="input-group-text">
...
<!-- AdminLTE App -->
<script src="{{asset('new_admin/dist/js/adminlte.min.js')}}"></script>
</body>
</html>
