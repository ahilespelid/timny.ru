      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"> <a href='#'>Add General Settings </a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="file"  onchange="openFile(this)" onchange="openFile(this)" class="form-control h-100"   name="logo">
                          </div>
