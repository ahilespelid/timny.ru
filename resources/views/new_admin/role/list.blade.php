                  ...
                  <table id="admin_users" class="table table-bordered table-striped">
                    ...
                    @foreach ($roles as $role)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.role.edit', $role->id) }}"><i class="fas fa-edit"></i></a>
                                <a onclick="deleteRow('{{route('admin.role.delete',['id'=>$role->id])}}')"><i class="fas fa-trash text-danger ml-2"></i></a>
                            </td>
                        </tr>
                        @php
                            $count++;
