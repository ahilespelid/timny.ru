                ...
                {{-- <div class="col-lg-12 mt-3">
                    <div class="card">
                        <div class="card-body">
                            <h2>Personal Info</h2>
                            <div class="col-lg-12">
                                <form action="{{ route('admin.mentor.store') }}" enctype="multipart/form-data"
                                    method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select aria-label="Default select example" name="occupation"
                                                    ...
                                                    @foreach ($occupations as $occupation)
                                                        <option value="{{ $occupation->id }}">{{ $occupation->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="bank" class="form-control" id="">
                                                            ...
                                                            @foreach ($banks as $bank)
                                                                <option value="{{ $bank->name }}">{{ $bank->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                ...
                                <div class="bs-stepper linear">
                                    ...
                                    <div class="bs-stepper-content">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label>Profile Image</label>
                                                            <input type="file"  onchange="openFile(this)" id="img"
                                        ...
                                        <div id="skills" class="content" role="tabpanel"
                                            ...
                                            <button class="btn btn-primary" onclick="stepper.next()">Next</button>
                                            <button class="btn btn-success" onclick="saveSkills()">save</button>
                                        ...
                                        <div id="bank-info" class="content" role="tabpanel"
                                            ...
                                            <button class="btn btn-primary" onclick="stepper.previous()">Previous</button>
                                            <button class="btn btn-primary" onclick="stepper.next()">Next</button>
                                            <button class="btn btn-success" onclick="saveBank()">Save</button>
                                        ...
                                        <div id="education-info" class="content" role="tabpanel"
                                            ...
                                            <button class="btn btn-primary" onclick="stepper.previous()">Previous</button>
                                            <button class="btn btn-primary" onclick="stepper.next()">Next</button>
                                            <button class="btn btn-success" onclick="saveEducation()">Save</button>
