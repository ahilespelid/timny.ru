...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Pending Consultant List</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="">Home</a></li>
            <li class="breadcrumb-item active">Pending Consultant </li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Pending Consultant </h3>
                            ...
                            @foreach ($pending_mentors as $mentor)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="deleteRow('{{route('admin.mentor.delete',['id'=>$mentor->id])}}')"><i class="ml-2 fas fa-trash text-danger"></i></a>
                                    </td>
                                </tr>
                                @php
                                    $count++;
