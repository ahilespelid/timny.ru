...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Approved Consultant List</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="">Home</a></li>
            <li class="breadcrumb-item active"> Approved Consultant List</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Approved Consultant </h3>
                        ...
                        @php
                            ...
                            @foreach ($approved_mentors as $mentor)
                                <tr>
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{ route('admin.mentor.detail', $mentor->user_id) }}"><i class="fas fa-edit text-primary"></i></a>
                                        <a onclick="deleteRow('{{route('admin.mentor.delete',['id'=>$mentor->id])}}')"><i class="ml-2 text-danger mdi mdi-delete"></i></a>
                                    </td>
                                </tr>
                                @php
                                    $count++;
