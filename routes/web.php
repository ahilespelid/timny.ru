...
Route::get('/appointment-schedule/{id}/{appointmentid?}', function ($id,$appointmentid=null)
{
  ...
  if($appointmentid){
          return view('appointment-schedule', compact('url', 'mentor_id', 'routeLive','appointmentid'));
      }
...
//payment process UKassa
Route::get('/processingPaymentUKassa',[UKassa::class,'verifyPayment']);
Route::post('/processingPaymentUKassaWebHook',[UKassa::class,'webHook']);
